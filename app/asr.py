...
async def transcribe_pcm(pcm_bytes: bytes, session: Optional[Session] = None) -> str:
    ...
    transcript = await client.audio.transcriptions.create(
        ...
        prompt="HiTony语音助手。播放音乐，放首歌，来一首，播放周杰伦的歌，播放Taylor Swift，播放邓紫棋，暂停，停止播放，继续播放，提醒我，查看提醒，取消提醒，今天天气怎么样，倒计时，取消倒计时，搜索，帮我查一下，开始会议，结束会议，记一下，笔记，帮我记，备忘，清空对话，新对话，忘掉对话，你好。",
    )
